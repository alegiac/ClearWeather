...
//	public static final String I_KEY_REFRESH ="i_key_refresh"; // integer
//	public static final String B_KEY_EXE ="b_key_exe"; // is widget loading
	...
	public static String getURLweather(String id)
	{
		...
		builder.scheme("http").authority("api.openweathermap.org")
			...
			.appendQueryParameter("APPID", "2b350a87de1accceaaa66f9...");
	...
	public static String getURLforecast(String id)
	{
		...
		builder.scheme("http").authority("api.openweathermap.org")
			...
			.appendQueryParameter("mode", "json")
			.appendQueryParameter("units", "metric")
			.appendQueryParameter("APPID", "2b350a87de1accceaaa66f99...");
		URL = builder.build().toString();
		return URL;
	}
