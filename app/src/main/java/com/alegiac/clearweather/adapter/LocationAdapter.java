package com.alegiac.clearweather.adapter;
...
public class LocationAdapter extends BaseAdapter {
	...
	public LocationAdapter(MainActivity act, ArrayList<Location> results) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		try{
			...
			global.setLytColor(weather.weather.get(0).icon, holder.bg_item);
	...
	protected void dialogDeleteConfirmationFlat(final String id) {
	    ...
	    Location itemloc = global.getLocation(id);
